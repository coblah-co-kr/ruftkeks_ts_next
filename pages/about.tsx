...
export default function About() {
    ...
    return (
        <div className="mx-auto h-auto grid justify-items-center dark:text-indigo-400">
            <Seo subtitle = "About"/>
            ...
            Turn {(typeof window !== 'undefined')?(localStorage.getItem("theme") == "dark" ? "On" : "Off"):"Off"} Dark Mode
            </span>
            </label>
            {isKakaoMapLoaded && (
                <div className="flex flex-col mt-10">
                    <div className="flex flex-row mb-5 mx-20">
                        <img src={profileImg ? `https://ruuftkeksimg.s3.ap-northeast-2.amazonaws.com/${profileImg}` : "/icons/no_profile.png"} className="w-2/5 dark:filter dark:brightness-75"/>
                        <div className="flex flex-col justify-around ml-5 hansans">
                            <p>
                                {`${name}(${nickname})`}
                            </p>
                            <p>
                            ...
                            <p className="dark:border-slate-200 border-2">
                                <img className="w-7" src={getIconFromLink(links[0])} alt="" onClick={ () => router.push(links[0])}/>
                            </p>
                        </div>
                    </div>
                    <div className="mb-5 mx-20 hansans">
                        {address}
                    </div>
                    <div className="flex flex-col justify-center">
                        <img className="rounded-xl dark:filter dark:brightness-75" src={`https://ruuftkeksimg.s3.ap-northeast-2.amazonaws.com/${overviewImg}`} alt="" />
                    </div>
                </div>
            )}
            {!isKakaoMapLoaded ? <h4>Loading..</h4> : (
                <div id="map" className="rounded-xl shadow-lg px-48 py-96 mt-10 dark:filter dark:brightness-75"/>
            )}
